...
//    TODO 复制
    ...
    protected function pramData(){
    	  //mydev 产品参数
        $goods_arg_data=array(array("title"=>"型号","name"=>"goods_modal"),
                              array("title"=>"材质","name"=>"goods_tex"),
                              array("title"=>"风格","name"=>"goods_style"),
                              array("title"=>"尺寸","name"=>"goods_size"),
                              array("title"=>"适应对象","name"=>"goods_obj"),
                              array("title"=>"适应区域","name"=>"goods_area"),
                              array("title"=>"涂料光泽","name"=>"goods_coat"),
                              array("title"=>"计价单位","name"=>"goods_unit"),
                              array("title"=>"总量kg","name"=>"goods_weit"),
                              array("title"=>"包装数量","name"=>"goods_pack"),
		                     );
	    $this->assign("goods_arg_data",$goods_arg_data);
    }
    /**
     * Notes:编辑商品
    ...
    public function edit($goods_id)
    {
        ...
        //mydev
        $this->pramData();
		$info=GoodsLogic::info($goods_id);
		$this->assign("pram_info",$info['base']['goods_arg']);
        $this->assign('category_lists', json_encode(GoodsCategoryLogic::getAllTree(), JSON_UNESCAPED_UNICODE));
