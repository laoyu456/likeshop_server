...
class Menu_{
	...
	const index_tc          = 13;
    const index_cj          = 14;
    const index_tc_spe      = 15;
    const index_cj_spe      = 16;
    /*
     * 个人中心菜单
     */
    ...
    public static function getMenuContent($scene = true,$from = true){
        ...
        $config1 = [
            ...
            self::index_tc            => [
                'name'          => '同城实体',
                'link'          => '/pages/goods_search/goods_search?type=1&id=1_0&name=同城实体',
                'is_tab'        => 0,
                'link_type'     => 1, 
                'menu_type'     => 1,
            ],
            self::index_cj      => [
                'name'          => '厂家直销',
                'link'          => '/pages/goods_search/goods_search?type=1&id=0_0&name=厂家直销',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_tc_spe           => [
                'name'          => '同城特价',
                'link'          => '/pages/goods_search/goods_search?type=1&id=1_1&name=同城特价',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_cj_spe      => [
                'name'          => '厂家特价',
                'link'          => '/pages/goods_search/goods_search?type=1&id=0_1&name=厂家特价',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
