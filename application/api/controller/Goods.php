...
class Goods extends ApiBase{
    ...
    public function getGoodsDetail(){
		...
		//mydev
	    $goods_arg=json_decode($goods->goods_arg,TRUE);
		$goods_arg['prov_city']=$goods->province." ".$goods->pro_city;
		$brand_info=model("goods_brand")->find($goods->brand_id);
		$goods_arg['brand_name']=$brand_info['name']?$brand_info['name']:"无";
		$goods->goods_arg=$goods_arg;
        if($goods){
