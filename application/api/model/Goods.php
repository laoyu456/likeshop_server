...
class Goods extends Model{
    ...
    public function Like(){
       ...
       //mydev
       $goods_arg_data=array(array("title"=>"品牌","name"=>"brand_name"),
                              array("title"=>"型号","name"=>"goods_modal"),
                              array("title"=>"材质","name"=>"goods_tex"),
                              array("title"=>"风格","name"=>"goods_style"),
                              array("title"=>"产地","name"=>"prov_city"),
	   ...
	   $this->setAttr('goods_arg_info',$goods_arg_data);  
	}
